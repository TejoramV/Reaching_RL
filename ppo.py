...
class PPO:
    ...
    def collect_rollouts(self, num_steps):
        ...
        for _ in trange(steps_per_env, desc='collecting rollouts'):
            ...
            print(infos[0]['current_images'][0][0]['depth_aligned'].shape)
            depth_ima = infos[0]['current_images'][0][0]['depth_aligned']
            cv2.imwrite('/home/weirdlab/data/'+str(_)+'.png',depth_ima)
    ...
    def evaluate(self):
        ...
        while not np.all(dones):
            ...
            #print(self.eval_envs.render().shape)
            obs = next_obs
        # print(obs.shape)
        # print(obs)
        # print(actions)
